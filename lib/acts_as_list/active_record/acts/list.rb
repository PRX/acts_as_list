    ...
    module List #:nodoc:
      ...
      module InstanceMethods
        ...
        def higher_item
          ...
          acts_as_list_class.first("#{scope_condition} AND #{position_column} = #{(send(position_column).to_i - 1).to_s}")
        end
        ...
        private
          ...
          def bottom_item(except = nil)
            ...
            acts_as_list_class.order("#{position_column} DESC").first(conditions)
          end
